      ...
      <div className="projects-content w-full bg-[#1d1d1d] text-[#6aff7f] py-10 md:py-20 overflow-scroll">
          ...
          <div className="w-full flex flex-col justify-center items-center h-full px-0 md:px-10 lg:px-32">
            <div className='w-full md:columns-2 lg:columns-3 gap-4 space-y-4 px-20 md:p-5'>
              ...
              <Cards heading="Foodie Land" imagePath={Foodie} imagePath2={Foodie2} alt="foodie land" details="A food recipe website" stack="html . css . js . tailwindcss . nextJs ." demoLink="https://foodeeland.netlify.app/" building={false}
              // codeLink="https://github.com/AkhatorEnosa/foodie_land"
              />

              <Cards heading="Techkare" imagePath={Techkare} imagePath2={Techkare} alt="techKare" details="Healthcare Facility Dashboard displaying a Patient's Data" stack="html . css . js . tailwindcss . reactjs . api" demoLink="https://techkare.netlify.app/" building={false}
              // codeLink="https://github.com/AkhatorEnosa/techcare"
              />

              <Cards heading="Lokateur" imagePath={Lokateur} imagePath2={Lokateur} alt="Lokateur" details="Geolocation grabber with IP address website" stack="html . css . js . tailwindcss . reactjs . api" demoLink="https://Lokateur.netlify.app/" building={false}
              // codeLink="https://github.com/AkhatorEnosa/Lokateur"
              />

              <Cards heading="Splitter" imagePath={Splitter} imagePath2={Splitter} alt="Splitter" details="This project is based around building a web app to easily split bills between two or more persons including tips(if needed)" stack="html . css . js" demoLink="https://splitify.netlify.app/" building={false}
              // codeLink="https://github.com/AkhatorEnosa/bill-splitter-app"
              />

              <Cards heading="Unscramble Game" imagePath={Unscramble} imagePath2={Unscramble} alt="Unscramble" details="A word unscrambling game" stack="html . css . js . reactjs . api" demoLink="https://akhatorenosa.github.io/unscramble-game/" building={false}
              // codeLink="hub.com/AkhatorEnosa/unscramble-game"
              />

              <Cards heading="Kickrs" imagePath={Kickrs} imagePath2={Kickrs} alt="kickrs" details="Product page for eCommerce website" stack="html . css . js . tailwindcss . reactjs" demoLink="https://kickrs.netlify.app/" building={false}
              ...
              <Cards heading="Genotype Matching App" imagePath={Genotype} imagePath2={Genotype} alt="Genotype" details="This app helps couples confirm if their genotypes are compatible for their unborn children" stack="html . css . js" demoLink="https://akhatorenosa.github.io/genotype_match_checker" building={false}
              // codeLink="https://github.com/AkhatorEnosa/genotype-match-checker"
              />

              <Cards heading="Kwota" imagePath={Kwota} imagePath2={Kwota} alt="Kwota" details="Random quotes generator."  stack="html . css, reactjs" demoLink="https://kwota.netlify.app/" building={false}
              // codeLink="https://github.com/AkhatorEnosa/quotes-app"
              />
            </div>
          </div>
