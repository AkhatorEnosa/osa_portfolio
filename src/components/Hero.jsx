  ...
  return (
    <section  className="hero w-full flex flex-col justify-center h-screen items-center bg-[#003816] text-[#6aff7f]">
        ...
        <div className="absolute flex flex-col px-40 gap-2 text-center">
            ...
            <h2 className='hero-content text-7xl md:text-9xl font-extrabold tracking-tighter w-full text-center text-white opacity-0 z-0'>
                Akhator Osakhogba
            </h2> 
            <p className="hero-content bounce text-2xl md:text-5xl uppercase font-thin opacity-0">Frontend Developer</p>
        </div>
    </section>
  )
}
