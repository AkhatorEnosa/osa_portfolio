...
const Sidebar = () => {
  return (
       ...
       <div className='side-bar opacity-0 flex fixed w-full md:w-fit flex-col bottom-0 md:top-0 justify-center items-center md:justify-normal md:items-start md:left-0 z-50 font-extralight text-xs text-white bg-[#003816] bg-transparent z-10'>
