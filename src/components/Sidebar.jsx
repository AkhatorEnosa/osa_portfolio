  ...
  return (
       ...
       <div className='side-bar flex fixed w-full md:w-fit flex-col bottom-0 md:top-[20%] justify-center items-center md:justify-normal md:items-start md:left-0 z-50 font-extralight text-xs text-white bg-[#003816] bg-transparent'>
        <ul className="flex md:flex-col">
          ...
          <li className='side-link md:w-[150px] h-[60px] flex items-center px-5 md:px-5 md:-translate-x-20 hover:-translate-x-0 hover:rounded-r-lg duration-300 bg-green-700 z-50  rounded-tr-lg'>
          ...
          <li className='side-link md:w-[150px] h-[60px] flex items-center px-5 md:px-5 md:-translate-x-20 hover:-translate-x-0 hover:rounded-r-lg duration-300 bg-black z-50'>
          ...
          <li className='side-link md:w-[150px] h-[60px] flex items-center px-5 md:px-5 md:-translate-x-20 hover:-translate-x-0 hover:rounded-r-lg duration-300 bg-blue-900 z-50'>
          ...
          <li className='side-link md:w-[150px] h-[60px] flex items-center px-5 md:px-5 md:-translate-x-20 hover:-translate-x-0 hover:rounded-r-lg duration-300 bg-[#1EB854] z-50'>
          ...
          <li className='side-link md:w-[150px] h-[60px] flex items-center px-5 md:px-5 md:-translate-x-20 hover:-translate-x-0 hover:rounded-r-lg duration-300 bg-red-600 z-50 rounded-br-lg'>
