...
const Cards = (props) => {
  ...
  return (
      <div className='card w-full flex flex-col justify-between gap-4 items-center py-5 rounded-none md:rounded-lg bg-white text-[#003816] cursor-pointer opacity-85 lg:shadow-sm lg:hover:shadow-none transition-all duration-500 z-50'>
